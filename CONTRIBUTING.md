...
> [Documentation](https://parsnip-cif.readthedocs.io/en/latest/).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/glotzerlab/parsnip/issues) that might help you. In case you
...
- Open an [Issue](https://github.com/glotzerlab/parsnip/issues/new).
- Provide as much context as you can about what you're running into.
- Provide the Python version you are using, the version of `parsnip`, and a minimal
  working example.
...
> contribute may be provided under the project [license](./LICENSE). You must also agree
...
- To see if other users have experienced (and potentially already solved) the same issue
  ...
  error in the
  [bug tracker](https://github.com/glotzerlab/parsnip/issues?q=label%3Abug).
...
> bugs must be sent by email to
> [our contact email](mailto:55467578+janbridley@users.noreply.github.com).

We use GitHub issues to track bugs and errors. If you run into an issue with the
project:

- Open an [Issue](https://github.com/glotzerlab/parsnip/issues/new). (Since we can't be
...
- Make sure that you are using the latest version.
- Read the [documentation](https://parsnip-cif.readthedocs.io/en/latest/) carefully and
  find out if the functionality is already covered, maybe by an individual
  configuration.
- Perform a [search](https://github.com/glotzerlab/parsnip/issues) to see if the
...
- **Describe the current behavior** and **explain which behavior you expected to see
  ...
  you.
- **Explain why this enhancement would be useful** to most parsnip users. You may also
  want to point out the other projects that solved it better and which could serve as
  inspiration.

Please use our
[feature request](https://github.com/glotzerlab/parsnip/issues/new?template=feature_request.md)
template to request any enhancements!
